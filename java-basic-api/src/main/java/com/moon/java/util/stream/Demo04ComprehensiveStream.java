 ...
 * @description
 */
public class Demo04ComprehensiveStream {

    /**
     * Stream流综合示例
     */
    @Test
    public void comprehensiveStreamTest01() {
    ...
    public void comprehensiveStreamTest02() {
        ...
        // 2.第一个队伍筛选之后只要前3个人;
        Stream<String> streamA = teamA.stream()
                .filter(s -> s.length() == 4)
                .limit(3);

        // 3.第二个队伍只要包含“美”字的成员姓名;
        // 4.第二个队伍筛选之后不要前2个人;
        Stream<String> streamB = teamB.stream()
                .filter(s -> s.contains("美"))
                .skip(2);
